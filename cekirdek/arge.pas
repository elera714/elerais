{==============================================================================
  ...
  Dosya Adı: arge.pas
  Dosya İşlevi: sistem ar-ge çalışmalarını içerir
...
begin
  ...
  P1Masaustu := P1Masaustu^.Olustur('giriş');
  ...
  begin
    ...
    begin
      ...
      P4GucDugmesi := P4GucDugmesi^.Olustur(ktNesne, P2Pencere,
        SonKonumY, SonKonumD, 100, 20, 'TGüçDüğmesi');
      P4GucDugmesi^.Goster;
    end
    ...
    begin
      ...
      P4GirisKutusu := P4GirisKutusu^.Olustur(ktNesne, P2Pencere,
        SonKonumY, SonKonumD, 120, 20, 'TGirişKutusu');
