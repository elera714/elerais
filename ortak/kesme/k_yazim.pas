...
begin
  ...
  begin
    ...
    if(Pencere = nil) then Exit(HATA_NESNE);
  ...
  begin
    ...
    Pencere.MACAdresYaz(Pencere, A1, B1, PMACAdres(Bellek)^, PRenk(ADegiskenler + 12)^);
  ...
  begin
    ...
    Pencere.IP4AdresiYaz(Pencere, A1, B1, PIP4Adres(Bellek)^, PRenk(ADegiskenler + 12)^);
