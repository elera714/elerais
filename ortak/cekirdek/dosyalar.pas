...
function DosyaOrtaminiHazirla(const ADosyaAdi: string; ADST: TSayi4): TKimlik;
...
type
  ...
  public
    ...
    function Yeni(ADST: TSayi4): TDosya;
...
uses elr1, fat12, fat16, fat32, sistemmesaj, islevler, donusum, gercekbellek;
...
begin
  ...
  // arama iþleminin yapýlacaðý sürücüyü al
...
begin
  ...
  // dosya iþleminin yapýlacaðý sürücüyü al
  MD := GMantiksalDepolama.SurucuBul(ADosyaAdi);
  if(MD = nil) then
  begin

    { TODO - hata denetimi gerçekleþtir }
    Exit;
  end;

  ADosyaKimlik := DosyaOrtaminiHazirla(ADosyaAdi, MD.FDST);
end;
...
begin
  ...
  // dosya iþleminin yapýlacaðý sürücüyü al
  MD := GMantiksalDepolama.SurucuBul(AKlasorAdi);
  if(MD = nil) then
  begin
  ...
  DosyaKimlik := DosyaOrtaminiHazirla(AKlasorAdi, MD.FDST);
...
begin
  ...
  DosyaKimlik := DosyaOrtaminiHazirla(ADosyaAdi, MD.FDST);
...
{==============================================================================
 ...
 ==============================================================================}
function TDosyalar.Yeni(ADST: TSayi4): TDosya;
var
  D: TDosya;
  Kimlik: TISayi4;
  i: TSayi4;
begin
  ...
  begin
    ...
    begin
      ...
      Kimlik := GDosyalar.KimlikNoAl;

      case ADST of
        DST_ELR1    : D := TELR1.Create(Kimlik, ADST);
        DST_FAT12   : D := TFAT12.Create(Kimlik, ADST);
        DST_FAT16   : D := TFAT16.Create(Kimlik, ADST);
        DST_FAT32,
        DST_FAT32LBA: D := TFAT32.Create(Kimlik, ADST);
      end;
...
begin
  ...
  begin
    ...
    if not(AramaKaydi.DosyaAdi = '.') and not(AramaKaydi.DosyaAdi = '..') then
    begin
...
{==============================================================================
  görsel nesne için kimlik numarasý oluþturur
 ==============================================================================}
function TDosyalar.KimlikNoAl: TISayi4;
var
  i: TISayi4;
begin
  ...
  begin
    ...
    // eðer nesne oluþturulmamýþ ise
    if(DosyaListesi[i] = nil) then Exit(i);
  end;
end;
